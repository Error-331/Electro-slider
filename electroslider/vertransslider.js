...
jQuery.fn.ElectroSlider.VerTransSlider = function(usrConfig)
  {
  jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.constructor.call(this, usrConfig);    
  }
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.CheckRawSlides = function(usrSlides)
  {  
  jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.CheckRawSlides.call(this, usrSlides); 
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PrepareHTML = function()
  {    
  jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.PrepareHTML.call(this); 
  }
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PreparePanelContainer = function()
  {
  ...
  this.BackBtnCont = this.jQuery('<div class="' + this.CSSPrefix + '_ElectroSlider_BackBtnHor"><a href="#"><img src="'+this.ImagesFolder+'/up.png" border="0" title="Back button" alt="Up button"/></a></div>');
  ...
  this.ForwardBtnCont = this.jQuery('<div class="' + this.CSSPrefix + '_ElectroSlider_ForwardBtnHor"><a href="#"><img src="'+this.ImagesFolder+'/down.png" border="0" title="Forward button" alt="Down button"/></a></div>');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PreparePanelContainerPreloader = function()
  {	    
  var tmpWidth = this.BackBtnCont.width() + this.SliderPanelCont.width() + this.ForwardBtnCont.width();
  
  this.SliderPanelPreloader = this.jQuery('<div class="' + this.CSSPrefix + '_ElectroSlider_PanelContPreloader"><img src="images/slider/preloader.png"/></div>');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PrepareOuterContainerPreloader = function()
  {	
  var tmpSelf = this;

  this.SliderContOutPreloader = this.jQuery('<div class="' + this.CSSPrefix + '_ElectroSlider_ContOutPreloader"><img src="images/slider/preloader.png"/></div>');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PrepareInnerContainer = function()
  {
  ...
  this.SliderContIn.css('width', this.Width + 'px');
  this.SliderContIn.css('height', this.SumSlidesHeight + 'px');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PrepareSlides = function()
  {
  var tmpSelf = this;  
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.BeforeImagePreload = function()
  {
  jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.BeforeImagePreload.call(this); 
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PreloadControls = function()
  {  
  var tmpSelf = this;
  
  var tmpImgArr = new Array(this.ImagesFolder + '/up.png', this.ImagesFolder + '/down.png');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PreloadPreloader = function()
  {
  var tmpSelf = this;
  
  var tmpImgArr = new Array(this.ImagesFolder + '/preloader.png', this.ImagesFolder + '/forward.png');
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.PreloadUserImages = function()
  {
  var tmpSelf = this;
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.ResizeSlider = function()
  {
  var tmpWidth = 0;
    
  jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.ResizeSlider.call(this);  
    
  this.SliderContIn.css('width', this.Width);
  this.SliderContIn.css('height', this.SumSlidesHeight);
                     
  tmpPadding = (Number(this.Width) / 2) - (Number(this.BackBtnCont.find('a').width()) / 2);
  this.BackBtnCont.css('padding', '5px 0 5px ' + tmpPadding + 'px');

  tmpPadding = (Number(this.Width) / 2) - (Number(this.ForwardBtnCont.find('a').width()) / 2);
  this.ForwardBtnCont.css('padding', '5px 0 5px ' + tmpPadding + 'px');

  /* Centering starts here */

  if (this.IsHorCentered == true)
    {                   
    this.SliderPanelCont.css('width', this.SliderContOut.outerWidth(true) + 'px');         
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.AlignSlides = function()
  {
  var tmpSelf = this;
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.SelectItemInstant = function(usrItem)
  { 
  var tmpSlider = this;
  var tmpResult = jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.SelectItemInstant.call(this, usrItem);
  ...
  this.SliderContIn.css('top', 0 - tmpHeight);
...
jQuery.fn.ElectroSlider.VerTransSlider.prototype.SelectItem = function(usrStartItem, usrEndItem)
  {
  var tmpSelf = this;      
  var tmpResult = jQuery.fn.ElectroSlider.VerTransSlider.SuperClass.SelectItem.call(this, usrStartItem, usrEndItem);
  ...
  if (usrStartItem > usrEndItem) {tmpAnimObj.top = '+=' + tmpAnimeHeight;}
  else {tmpAnimObj.top = '-=' + tmpAnimeHeight;}
...
jQuery.fn.ElectroSlider.ExtendClassAfter(jQuery.fn.ElectroSlider.VerTransSlider, jQuery.fn.ElectroSlider.Slider);
jQuery.fn.ElectroSlider.onClassLoad('vertransslider');
